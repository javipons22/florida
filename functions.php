...
function wpt_theme_styles() { 
	...
	wp_enqueue_style( 'main_css', get_template_directory_uri() . '/style.e64548610c3.css' );
}
...
function wpt_theme_js() {
	...
	wp_enqueue_script('main_js', get_template_directory_uri() . '/js/app.46452dd6a7.js', array('jquery') , '' , true);
