...
function wpt_theme_styles() { 
	...
	wp_enqueue_style( 'main_css', get_template_directory_uri() . '/style.c255bad59.css' );
}
...
function wpt_theme_js() {
	...
	wp_enqueue_script('main_js', get_template_directory_uri() . '/js/app.c255bad59.js', array('jquery') , '' , true);
