...
function wpt_theme_styles() { 
	...
	wp_enqueue_style( 'main_css', get_template_directory_uri() . '/style.b24dd6c62.css' );
}
...
function wpt_theme_js() {
	...
	wp_enqueue_script('main_js', get_template_directory_uri() . '/js/app.b24dd6c62.js', array('jquery') , '' , true);
